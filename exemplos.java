...
public class exemplos {
  ...
  public static void main(String[] args) {
    ...
    // System.out.println("O valor da variável b é: %d%n", b);

    // System.out.println("O valor mínimo de int é %d e o valor máximo é %d %n",
    // Integer.MIN_VALUE, Integer.MAX_VALUE);
    // System.out.println("O valor mínimo de short é %d e o valor máximo é %d%n",
    // Short.MIN_VALUE, Short.MAX_VALUE);
    // System.out.println("O valor mínimo de long é %d e o valor máximo é %d%n",
    // Long.MIN_VALUE, Long.MAX_VALUE);
    // System.out.println("O valor mínimo de float é %f e o valor máximo é %f%n",
    // Float.MIN_VALUE, Float.MAX_VALUE);
    // System.out.println("O valor mínimo de double é %f e o valor máximo é %f%n",
    ...
    // System.out.println("Valores A = %d, B = %d, C = %d %n", a, b, c);
